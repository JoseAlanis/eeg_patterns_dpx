...
fig_path <- '/media/administrator/Crucial X8/code/eeg_patterns_dpx/data/bids/derivatives/limo/'
p1 <- ggdraw() +
  draw_image(paste0(fig_path, "cues_erps.png"),
             scale = 1, hjust=-0.1)
p2 <- ggdraw() +
  draw_image(paste0(fig_path, "ttest_cues_sensors_fmax.png"),
             scale = 1, hjust=0.1)
...
fig_path <- '/media/administrator/Crucial X8/code/eeg_patterns_dpx/data/bids/derivatives/limo/'
p1 <- ggdraw() +
  draw_image(paste0(fig_path, "probes_ax_ay_erps.png"),
             scale = 1, hjust=-0.1)
p2 <- ggdraw() +
  draw_image(paste0(fig_path, "ttest_probes_sensors_AY_AX_fmax.png"),,
             scale = 1, hjust=0.1)
